            ...
            <div class="row vertical-gap">
                ...
                <div class="col-md-6">
                    <div class="nk-product-cat">
                        <a class="nk-product-image" href="product">
                            <img src="assets/images/product-11-xs.jpg" alt="She gave my mother">
                        </a>
                        <div class="nk-product-cont">
                            <h3 class="nk-product-title h5"><a href="product">She gave my mother</a></h3>
                            <div class="nk-gap-1"></div>
                ...
                <div class="col-md-6">
                    <div class="nk-product-cat">
                        ...
                        <div class="nk-product-cont">
                            <h3 class="nk-product-title h5"><a href="product">A hundred thousand</a></h3>
                            <div class="nk-gap-1"></div>
                            <div class="nk-product-rating" data-rating="4.5"> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fas fa-star-half"></i></div>
                            <div class="nk-gap-1"></div>
                ...
                <div class="col-md-6">
                    <div class="nk-product-cat">
                        ...
                        <div class="nk-product-cont">
                            <h3 class="nk-product-title h5"><a href="product">So saying he unbuckled</a></h3>
                            <div class="nk-gap-1"></div>
                ...
                <div class="col-md-6">
                    <div class="nk-product-cat">
                        ...
                        <div class="nk-product-cont">
                            <h3 class="nk-product-title h5"><a href="product">However, I have reason</a></h3>
                            <div class="nk-gap-1"></div>
                ...
                <div class="col-md-6">
                    <div class="nk-product-cat">
                        ...
                        <div class="nk-product-cont">
                            <h3 class="nk-product-title h5"><a href="product">At first, for some time</a></h3>
                            <div class="nk-gap-1"></div>
                ...
                <div class="col-md-6">
                    <div class="nk-product-cat">
                        ...
                        <div class="nk-product-cont">
                            <h3 class="nk-product-title h5"><a href="product">When the last &#39;natural&#39;</a></h3>
                            <div class="nk-gap-1"></div>
                            <div class="nk-product-rating" data-rating="4.5"> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fas fa-star-half"></i></div>
                            <div class="nk-gap-1"></div>
                            <div class="nk-product-price">€ 20.00</div>
