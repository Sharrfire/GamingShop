						...
						<tbody>
							...
							<c:forEach items="${list}" var="o">
								<tr>
									...
									<td class="nk-product-cart-price">
										<div class="nk-gap-1"></div> <strong>${o.price}$</strong>
									</td>
									<td class="nk-product-cart-quantity">
										<div class="nk-gap-1"></div>
										...
										<div class="nk-form">
											...
											<strong>${o.amount}</strong> <a href="cart?id=${o.id}"><button
								...
								<tr>
									<td class="nk-product-cart-thumb"><a href="product"
										class="nk-image-box-1 nk-post-image"> <img
											src="${o.image}" alt="${o.name}" width="115" height="auto">
									</a></td>
									<td class="nk-product-cart-title">
