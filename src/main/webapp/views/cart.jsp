...
<div class="nk-main">
    ...
    <div class="container">
        <div class="nk-store nk-store-cart">
            <div class="table-responsive">
                ...
                <table class="table nk-store-cart-products">
                    ...
                    <tr>
                        ...
                        <td class="nk-product-cart-remove"><a href="removeProduct"><span class="ion-android-close"></span></a></td>
                    </tr>
            ...
            <div class="nk-gap-2"></div>
            <a class="nk-btn nk-btn-rounded nk-btn-color-main-1 float-right" href="checkout">Buy</a>
            <div class="clearfix"></div>
            <div class="nk-gap-2"></div>
        </div>
    </div>
