            ...
            <div class="row vertical-gap">
                <div class="col-md-6">
                    ...
                    <button type="submit" value=""
                            class="nk-btn nk-btn-rounded nk-btn-color-white nk-btn-block">Sign In
                    </button>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <ul class="nk-social-links-2">
                        <li><a class="nk-social-facebook" href="/AccessFacebook/login-facebook"><span
                                class="fab fa-facebook"></span></a></li>
                        <li><a class="nk-social-google-plus" target="_blank"
                               href="https://accounts.google.com/o/oauth2/auth/oauthchooseaccount?scope=email&redirect_uri=http%3A%2F%2Flocalhost%3A8080%2FAccessGoogle%2Flogin-google&response_type=code&client_id=352140522561-vpmetjr6bjce1vod9b0cppihhbcgdesh.apps.googleusercontent.com&approval_prompt=force&flowName=GeneralOAuthFlow"><span
