...
<div class="nk-main">
	...
	<div class="container">
		...
		<div class="nk-store nk-store-checkout">
				...
				<div class="row vertical-gap">
					...
					<div class="col-lg-6">
						...
						<label class="custom-control custom-checkbox"> <input
							...
							class="custom-control-indicator"></span> Ship to different
							address?
						</label>
					</div>
				</div>
			...
			<div class="table-responsive">
				<table class="nk-table nk-table-sm">
					...
					<tbody>
						...
						<tr>
							<td class="nk-product-cart-title">However, I have reason
								&times; 1</td>
							<td class="nk-product-cart-total">32.00$</td>
						</tr>

						<tr>
							<td class="nk-product-cart-title">She was bouncing &times; 1
							</td>
			...
			<div class="nk-gap-2"></div>
			<a class="nk-btn nk-btn-rounded nk-btn-color-main-1" href="#">Place
				Order</a>
		</div>
	</div>
