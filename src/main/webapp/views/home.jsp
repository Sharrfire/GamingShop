        ...
        <div class="nk-image-slider" data-autoplay="8000">
            ...
            <div class="nk-image-slider-thumbs"
                ...
                <ul style="transform: matrix(1, 0, 0, 1, -78.75, 0);">
                    <li class=""
                        style="background-image: url('assets/images/slide-1-thumb.jpg');">
                        <div
                                class="nk-image-slider-thumbs-overlay"></div>
                        <div class="nk-image-slider-thumbs-count">2</div>
                    </li>
                    <li class=""
                        style="background-image: url('assets/images/slide-2-thumb.jpg');">
                        <div
                                class="nk-image-slider-thumbs-overlay"></div>
                    </li>
                    <li class=""
                        style="background-image: url('assets/images/slide-3-thumb.jpg');">
                        <div
                                class="nk-image-slider-thumbs-overlay"></div>
                    </li>
                    <li class=""
                        style="background-image: url('assets/images/slide-4-thumb.jpg');">
                        <div
                                class="nk-image-slider-thumbs-overlay"></div>
                    </li>
                    <li class="nk-image-slider-thumbs-active"
                        style="background-image: url('assets/images/slide-5-thumb.jpg');">
                        <div
                                class="nk-image-slider-thumbs-overlay"></div>
                    </li>
                </ul>
                    ...
                    <div>
                        <div class="pl-5 pr-5">
                            <div class="nk-product-cat-3">
                                <a class="nk-product-image" href="product?id=${pt.id}"> <img
