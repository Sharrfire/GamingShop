    ...
    <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-3">
                    ...
                    <div class="nk-blog-post">
                        ...
                        <div class="nk-gap"></div>
                        <h2 class="nk-post-title h4"><a href="blog-article.html">At first, for some time, I was not able
                            to answer</a></h2>
                        <div class="nk-post-text">
                ...
                <div class="col-md-6 col-lg-3">
                    ...
                    <div class="nk-blog-post">
                        ...
                        <div class="nk-gap"></div>
                        <h2 class="nk-post-title h4"><a href="blog-article.html">At length one of them called out in a
                            clear</a></h2>
                        <div class="nk-post-text">
        ...
        <div class="row vertical-gap">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="nk-blog-post">
                                ...
                                <div class="nk-gap"></div>
                                <h2 class="nk-post-title h4"><a href="blog-article.html">He made his passenger captain
                                    of one</a></h2>
            ...
            <span class="bg-main-1">Action</span>
                                ...
                                <h2 class="nk-post-title h4"><a href="blog-article.html">Grab your sword and fight the
                                    Horde</a></h2>
            ...
            <span class="bg-main-3">Strategy</span>
                                ...
                                <div class="nk-gap-1"></div>
                                <h2 class="nk-post-title h4"><a href="blog-article.html">We found a witch! May we burn
                                    her?</a></h2>
                                <div class="nk-post-date mt-10 mb-10">
            ...
            <span class="bg-main-5">Racing</span>
                                ...
                                <div class="nk-gap-1"></div>
                                <h2 class="nk-post-title h4"><a href="blog-article.html">At length one of them called
                                    out in a clear</a></h2>
                                <div class="nk-post-date mt-10 mb-10">
                                    <span class="fa fa-calendar"></span> Jul 3, 2018
                                    <span class="fa fa-comments"></span> <a href="#">0 comments</a>
