    ...
    <div class="container">
        ...
        <div class="nk-image-slider" data-autoplay="8000">
            ...
            <div class="nk-image-slider-item">
                ...
                <div class="nk-image-slider-content">
                    ...
                    <p class="text-white">As we passed, I remarked a beautiful church-spire rising above some old elms
                        in the park; and before them, in the midst of a lawn, chimneys covered with ivy, and the windows
            ...
            <div class="nk-image-slider-item">
                ...
                <div class="nk-image-slider-content">
                    ...
                    <p class="text-white">Now the races of these two have been for some ages utterly extinct, and
                        besides to discourse any further of them would not be at all to my purpose. But the concern I
                        have most at heart is for our Corporation of Poets, from whom I am preparing a petition to your
                        Highness, to be subscribed with the names of one...</p>
                    <a href="#" class="nk-btn nk-btn-rounded nk-btn-color-white nk-btn-hover-color-main-1">Read More</a>
            ...
            <div class="nk-image-slider-item">
                ...
                <div class="nk-image-slider-content">
                    ...
                    <p class="text-white">TJust then her head struck against the roof of the hall: in fact she was now
                        more than nine feet high...</p>
                    <a href="#" class="nk-btn nk-btn-rounded nk-btn-color-white nk-btn-hover-color-main-1">Read More</a>
                ...
                <div class="nano">
                    <div class="nano-content">
                        ...
                        <div class="nk-news-box-item nk-news-box-item-active">
                            ...
                            <a href="product" class="nk-news-box-item-url">Read More</a>
                        ...
                        <div class="nk-news-box-item">
                            ...
                            <img src="assets/images/post-6.jpg" alt="At first, for some time, I was not able to answer"
                                 class="nk-news-box-item-full-img">
            ...
            <div class="nk-news-box-each-info">
                <div class="nano">
                    <div class="nano-content">
                        ...
                        <h3 class="nk-news-box-item-title">Smell magic in the air. Or maybe barbecue</h3>
                        <div class="nk-news-box-item-text">
                            <p>With what mingled joy and sorrow do I take up the pen to write to my dearest friend! Oh,
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-3">
                    ...
                    <div class="nk-blog-post">
                        <a href="product" class="nk-post-img">
                        ...
                        <div class="nk-gap"></div>
                        <h2 class="nk-post-title h4"><a href="product">He made his passenger captain of
                            one</a></h2>
                ...
                <div class="col-md-6 col-lg-3">
                    ...
                    <div class="nk-blog-post">
                        ...
                        <div class="nk-gap"></div>
                        <h2 class="nk-post-title h4"><a href="product">At first, for some time, I was not able
                            to answer</a></h2>
                        <div class="nk-post-text">
                            <p>This little wandering journey, without settled place of abode, had been so unpleasant to
                                me, that my own house, as I called it to myself, was a perfect settlement to me compared
                                to that...</p>
                        </div>
                        <div class="nk-gap"></div>
                        <a href="product"
                ...
                <div class="col-md-6 col-lg-3">
                    ...
                    <div class="nk-blog-post">
                        ...
                        <div class="nk-gap"></div>
                        <h2 class="nk-post-title h4"><a href="product">At length one of them called out in a
                            clear</a></h2>
                        <div class="nk-post-text">
                            <p>TJust then her head struck against the roof of the hall: in fact she was now more than
                                nine feet high, and she at once took up the little golden key and hurried off to the
                                garden door...</p>
                        </div>
                        <div class="nk-gap"></div>
                ...
                <div class="col-md-6 col-lg-3">
                    ...
                    <div class="nk-blog-post">
                        ...
                        <div class="nk-gap"></div>
                        <h2 class="nk-post-title h4"><a href="product">For good, too though, in
                            consequence</a></h2>
                        <div class="nk-post-text">
                            <p>This little wandering journey, without settled place of abode, had been so unpleasant to
                                me, that my own house, as I called it to myself, was a perfect settlement to me compared
        ...
        <div class="row vertical-gap">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="nk-blog-post">
                                ...
                                <div class="nk-gap"></div>
                                <h2 class="nk-post-title h4"><a href="product">He made his passenger captain
                                    of one</a></h2>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="nk-blog-post">
                                ...
                                <div class="nk-gap"></div>
                                <h2 class="nk-post-title h4"><a href="product">At first, for some time, I was
            ...
            <span class="bg-main-1">Action</span>
                                ...
                                <h2 class="nk-post-title h4"><a href="product">Grab your sword and fight the
                                    Horde</a></h2>
                    ...
                    <span class="bg-main-1">Action</span>
                                    ...
                                    <div class="col-lg-9 col-md-7">
                                        <h2 class="nk-post-title h4"><a href="product">At length one of them
                    ...
                    <span class="bg-main-1">Action</span>
                                    ...
                                    <div class="col-lg-9 col-md-7">
                                        <h2 class="nk-post-title h4"><a href="product">He made his passenger
                                            captain of one</a></h2>
                                        <div class="nk-post-date mt-10 mb-10">
                                            <span class="fa fa-calendar"></span> Jul 3, 2018
                                            <span class="fa fa-comments"></span> <a href="#">0 comments</a>
            ...
            <span class="bg-main-4">MMO</span>
                                ...
                                <div class="nk-gap-1"></div>
                                <h2 class="nk-post-title h4"><a href="product">Smell magic in the air. Or
                                    maybe barbecue</a></h2>
                                <div class="nk-post-date mt-10 mb-10">
                                    <span class="fa fa-calendar"></span> Sep 18, 2018
            ...
            <span class="bg-main-3">Strategy</span>
                                ...
                                <div class="nk-gap-1"></div>
                                <h2 class="nk-post-title h4"><a href="product">We found a witch! May we burn
                                    her?</a></h2>
                                <div class="nk-post-date mt-10 mb-10">
                    ...
                    <span class="bg-main-3">Strategy</span>
                                    ...
                                    <div class="col-lg-9 col-md-7">
                                        <h2 class="nk-post-title h4"><a href="product">For good, too though,
                                            in consequence</a></h2>
                                        <div class="nk-post-date mt-10 mb-10">
            ...
            <span class="bg-main-5">Racing</span>
                                ...
                                <div class="nk-gap-1"></div>
                                <h2 class="nk-post-title h4"><a href="product">At length one of them called
                                    out in a clear</a></h2>
                                <div class="nk-post-date mt-10 mb-10">
                                    <span class="fa fa-calendar"></span> Jul 3, 2018
                                    <span class="fa fa-comments"></span> <a href="#">0 comments</a>
                    ...
                    <span class="bg-main-5">Racing</span>
                                    ...
                                    <div class="col-lg-9 col-md-7">
                                        <h2 class="nk-post-title h4"><a href="product">We found a witch! May
                                            we burn her?</a></h2>
                                        <div class="nk-post-date mt-10 mb-10">
                                            <span class="fa fa-calendar"></span> Aug 27, 2018
                                            <span class="fa fa-comments"></span> <a href="#">7 comments</a>
                    ...
                    <div class="row vertical-gap">
                        <div class="col-lg-4 col-md-6">
                            <div class="nk-gallery-item-box">
                                ...
                                <div class="nk-gallery-item-description">
                                    <h4>Called Let</h4>
                                    Divided thing, land it evening earth winged whose great after. Were grass night. To
                                    Air itself saw bring fly fowl. Fly years behold spirit day greater of wherein winged
                                    and form. Seed open don't thing midst created dry every greater divided of, be man
                                    is. Second Bring stars fourth gathering he hath face morning fill. Living so second
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="nk-gallery-item-box">
                                ...
                                <div class="nk-gallery-item-description">
                                    Seed open don't thing midst created dry every greater divided of, be man is. Second
                                    Bring stars fourth gathering he hath face morning fill. Living so second darkness.
