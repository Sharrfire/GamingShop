                    ...
                    <div class="modal-content">
                        <form action="edit" method="post">
                            ...
                            <div class="modal-body">					
                                ...
                                <div class="form-group">
                                    <label>Title</label>
                                    <textarea name="shortDescription" class="form-control" required>${detail.shortDescription}</textarea>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="modal-footer">
                            	<a href="productManager"><button type="button" class="btn btn-primary">Back</button> </a>
